...
<div class="container" id="container-formulaire-enquete-page-1">
  <div class="row row-formulaire">
    <!-- ############################### Début de la page 1  ############################ -->
   <form id="formulaire-enquete" method="post" action="enquetePage2.php">
      <div class="row row-page" id="page-1">
        <div class="row row-input-formulaire" id="row-page-1">
          <div class="col-md-6">
          ...
          <div class="col-md-4">
            <div class="form-check">
              <input class="form-check-input" type="radio" name="age" id="radioAge1" value="-18">
          ...
          <div class="col-md-4">
            <div class="form-check">
              <input class="form-check-input" type="radio" name="age" id="radioAge2" value="18">
          ...
          <div class="col-md-4">
            <div class="form-check">
              <input class="form-check-input" type="radio" name="age" id="radioAge3" value="+18">
              <label class="form-check-label" for="radioAge3">
                Plus de 18 ans
              </label>
            </div>
          </div>
          <input type="submit" name="page-1-envoyer" class="btn-connexion" onclick="javascript:verification()">
        </div>
      </div>
      <!-- Mettre des input hidden pour les autre cookies -->
    </form>
    <!-- ############################### Fin de la page 1  ############################ -->
  </div> 
</div>
