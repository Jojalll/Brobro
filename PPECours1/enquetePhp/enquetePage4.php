<?php
  if (isset($_POST["page-3-envoyer"])){
  	 setcookie("radioChoix", $_POST['radioChoix'], time() + 3600);
  }
?>
...
<div class="container" id="container-formulaire-enquete-page-1">
  <div class="row row-formulaire">
   <form id="formulaire-enquete" method="post" action="enquetePage5.php">
      <div class="row row-page" id="page-1">
        	   <!-- ############################### Début page 4  ############################ -->
        <div class="row row-input-formulaire" id="row-page-4">
          <div class="col-md-12">
            <div class="form-group">
              <label for="textAreaCommentaire">Vos commentaire</label>
              <textarea name="textArea" class="form-control" id="textAreaCommentaire" rows="3"></textarea>
            </div>
          </div>
          <input type="submit" name="page-4-envoyer" class="btn-connexion" onclick="javascript:verification()">
        </div>
      <!-- ############################### Fin page 4  ############################ -->
      </div>
    </form>
