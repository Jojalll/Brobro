<?php
  if (isset($_POST["page-2-envoyer"])){
  	 if (isset($_POST["checkbox1"])){
  	 	setcookie("choix1", $_POST['checkbox1'], time() + 3600);
  	 }
  	 	 if (isset($_POST["checkbox2"])){
  	 	 	setcookie("choix2", $_POST['checkbox2'], time() + 3600);
  	 	 }
  	 	 	 if (isset($_POST["checkbox3"])){
  	 	 	 	setcookie("choix3", $_POST['checkbox3'], time() + 3600);
  	 	 	 }
  }
?>
...
<div class="container" id="container-formulaire-enquete-page-1">
  <div class="row row-formulaire">
   <form id="formulaire-enquete" method="post" action="enquetePage4.php">
      <div class="row row-page" id="page-1">
        	  <!-- ############################### Début page 3  ############################ -->

        <div class="row row-input-formulaire" id="row-page-3">
          <div class="col-md-4">
            <div class="form-check">
              <input class="form-check-input" type="radio" name="radioChoix" id="radioChoix1" value="ma Value 1">
              <label class="form-check-label" for="radioChoix1">
                Radio choix 1
              </label>
            </div>
          </div>
          <div class="col-md-4">
            <div class="form-check">
              <input class="form-check-input" type="radio" name="radioChoix" id="radioChoix2" value="ma Value 2">
              <label class="form-check-label" for="radioChoix2">
                Radio choix 2
              </label>
            </div>
          </div>
          <div class="col-md-4">
            <div class="form-check">
              <input class="form-check-input" type="radio" name="radioChoix" id="radioChoix3" value="ma Value 3">
              <label class="form-check-label" for="radioChoix3">
                Radio choix 3
              </label>
            </div>
          </div>
          <input type="submit" name="page-3-envoyer" class="btn-connexion" onclick="javascript:verification()">
      </div>
      <!-- ############################### Fin page 3  ############################ -->
      </div>
    </form>
